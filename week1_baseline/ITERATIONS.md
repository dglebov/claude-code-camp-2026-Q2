...
## What should a baseline agent enable to do?
It should be able to play the MUD though we will have to give it specific commands
## What will not be able to do?
It will have poor peception since it doesn't have a way of managing memory, or decision making, or be effectivel
...
- Some SDKS even offical ones do not expose all features and so REST API will give full access
to feature sets
...
- We should attemp to use STDs as much as possible 
...
-We will need to make some manual adjustments since the original code did not exist in a ruby
sub-folder
...
## Student Completition Aproach 

As a stuaent you nave some flexibility in now you can get through this week:.
...
- You can watch all the videos and then do a single port of the last ruby interation to your
langauge of choice.
- You don't have to port the ruby but you will have to use it in your Week 2 when we implement
extra capabilities.
