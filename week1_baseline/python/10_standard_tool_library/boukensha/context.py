"""Port of `ruby/10_standard_tool_library/lib/boukensha/context.rb`.
...
class Context:
    def __init__(self, *, task, system=None, working_dir=None):
        ...
        self.task = task
        self.system = system
        # Metadata only — the tool modules receive working_dir directly, so nothing reads this.
        # Carried because Ruby's Context does.
