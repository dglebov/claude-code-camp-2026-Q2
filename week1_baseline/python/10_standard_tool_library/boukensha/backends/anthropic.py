"""Port of `ruby/10_standard_tool_library/lib/boukensha/backends/anthropic.rb`.
...
class Anthropic(Base):
    ...
    def parse_response(self, response):
        ...
        Nearly a pass-through — Anthropic already speaks this shape. Ruby keys the outer hash
        with symbols and the inner blocks with strings (they come from parsed JSON); Python uses
        strings for both.
        """
