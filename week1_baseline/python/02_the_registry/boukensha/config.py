"""Port of `ruby/02_the_registry/lib/boukensha/config.rb`.

Carried forward unchanged from step 01. There is no PROMPTS_DIR constant — the library ships no
default prompts, so `system_prompt` resolves only from the user's override dir.
"""
