"""Port of `ruby/05_agent_loop/lib/boukensha/errors.rb`.
...
class LoopError(Exception):
    ...
    winding down rather than raising. Mirrored from Ruby, which declares it and documents it in
    the step README without using it either. See the step-05 plan §8."""
