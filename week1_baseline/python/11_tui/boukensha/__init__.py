...
def run(
    *,
    ...
    try:
        ...
        # Checked here rather than left to Tasks.Base, which raises a bare ValueError and — for a
        # session started from outside any project — spills a traceback at someone whose only
        # mistake was their working directory. Explicit condition, not a rescue, so nothing else
        # is swallowed.
