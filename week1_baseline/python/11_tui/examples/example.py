...
#
# This is the non-interactive counterpart to the TUI: it runs one task to completion and prints
# the result, exercising the same tools without taking over the screen. For the TUI itself:
#
#   week1_baseline/bin/python/11_tui              # Textual TUI
#   week1_baseline/bin/python/11_tui --no-tui     # plain terminal REPL
#
# MUD tools reach this tree the language-neutral way — an MCP server declared in settings.yaml
# under mcp_servers: — rather than through a built-in module as Ruby's step 10 once did.
#
#   mcp_servers:
#     - name: mud
#       command: mud-manager
