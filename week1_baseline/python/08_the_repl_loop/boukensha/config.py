"""Port of `ruby/08_the_repl_loop/lib/boukensha/config.rb`.
...
class Config:
    ...
    def _resolve_dir(self):
        # Three tiers as of step 08. A REPL is typically launched from inside a project, so a
        # project-local .boukensha now wins over the home default.
        # 1. Explicit override
