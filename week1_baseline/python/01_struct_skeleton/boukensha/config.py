"""Port of `ruby/01_struct_skeleton/lib/boukensha/config.rb`.

Carried forward from step 00 with one change: step 01 drops the PROMPTS_DIR constant, so the
library ships no default prompts and `system_prompt` resolves only from the user's override dir.
"""
