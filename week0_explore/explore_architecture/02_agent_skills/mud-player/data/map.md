...
Notable: large fountain. Clerics' Guild entrance to the west (guarded by a
knight templar); Grunting Boar Inn (a tavern, not our guild) to the east.
...
## By The Temple Altar
Exits: n -> countryside (unexplored, leads out of city), s -> The Temple Of Midgaard
...
Notable: several beastly fido mobs scavenging garbage here.

## The Dump
Exits: n -> Common Square, d -> sewer system (unexplored)
Notable: entrance to the sewers.
